...
OUTPUT_ARCH(arm)
ENTRY(_start)
SEARCH_DIR("=/home/zion369/Android/Uber-Toolchain/out/aarch64-linux-android-6.x/aarch64-linux-android/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
