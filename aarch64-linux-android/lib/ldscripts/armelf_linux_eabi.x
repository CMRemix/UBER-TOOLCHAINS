...
OUTPUT_ARCH(arm)
ENTRY(_start)
SEARCH_DIR("=/media/zion/Applications/ToolChains/out/aarch64-linux-android-6.x/aarch64-linux-android/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
